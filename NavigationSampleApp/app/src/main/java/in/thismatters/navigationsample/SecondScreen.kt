...
@Composable
fun SecondScreen(name :String ,navToThirdScreen:()->Unit){
    Column(
        modifier =Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Text(text = "This is The SecondScreen", fontSize = 24.sp)
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "Welcome $name", fontSize = 24.sp)
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { navToThirdScreen() }) {
            Text(text = "Go TO ThirdPage")
        }
    }
}
